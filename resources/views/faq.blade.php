        ...
        <div class="container">
            ...
            <div class="row r-faq-accordion-wrapper">
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="r-accordion">
                        <div class="r-accordion-heading">
                            How can i drop the rental Yacht?
                    ...
                    <div class="r-accordion">
                        <div class="r-accordion-heading">
                            What happen if i crash the Yacht?
                            <img src="assets/images/accordion-icon.jpg" alt="" class="r-accordion-icon"/>
                        </div>
                        <div class="r-accordion-body">
                            <h3>Answer</h3>
...
<!-- JQUERY:: APPEAR.JS -->
<script src="{{ asset('js/plugins/owl/owl.Yachtousel.min.js') }}"></script>
<script src="{{ asset('assets/js/plugins/owl/owl.Yachtousel2.thumbs.js') }}"></script>
